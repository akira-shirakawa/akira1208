...
<body>
  ...
  <button class="button bold">B</button><button class="button h2">H2</button><button class="button a">A</button><button class="button wp2">wrap</button> 
            ...
            <form action="../edit" method="post"> 
              {{ csrf_field() }}
                <input class="input" type="text" placeholder="title" name="title" value="{{$message->title}}" required>
                <input class="input" type="text" placeholder="category" name="category"  value="{{$message->category}}" required>
